		 ...
		 <div class="col-lg-10">
			<div class="tab-content" id="v-pills-tabContent">
					...
					<form>
					  <div class="form-row">
						...
						<div class="form-group col-md-3">
						  ...
						  <input type="text" class="form-control datepicker" id="purchaseDetailsPurchaseDate" name="purchaseDetailsPurchaseDate" readonly value="2020-12-09">
						</div>
						<div class="form-group col-md-2">
					...
					<form>
					  ...
					  <div class="form-row">
						  ...
						  <div class="form-group col-md-3">
							  ...
							  <input type="text" class="form-control datepicker" id="saleDetailsSaleDate" value="2020-12-09" name="saleDetailsSaleDate" readonly>
						  </div>
					  </div>
					  <div class="form-row">
						<div class="form-group col-md-2">
							...
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									...
									<input type="text" class="form-control datepicker" id="saleReportStartDate" value="2020-12-17" name="saleReportStartDate" readonly>
								  </div>
								  <div class="form-group col-md-3">
									<label for="saleReportEndDate">End Date</label>
									<input type="text" class="form-control datepicker" id="saleReportEndDate" value="2020-12-20" name="saleReportEndDate" readonly>
								  </div>
							  </div>
							...
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									...
									<input type="text" class="form-control datepicker" id="purchaseReportStartDate" value="2020-12-17" name="purchaseReportStartDate" readonly>
								  </div>
								  <div class="form-group col-md-3">
									<label for="purchaseReportEndDate">End Date</label>
									<input type="text" class="form-control datepicker" id="purchaseReportEndDate" value="2020-12-20" name="purchaseReportEndDate" readonly>
								  </div>
							  </div>
			  ...
			  <div class="tab-pane fade" id="v-pills-users" role="tabpanel" aria-labelledby="v-pills-users-tab">
				<div class="card card-outline-secondary my-4">
					<div class="card-header">Add Your Users<button id="reportsTablesRefresh" name="reportsTablesRefresh" class="btn btn-warning float-right btn-sm">Refresh</button></div>
				  <div class="card-body">
				  ...
				  <div class="card-body">
					...
					<div class="form-row">
					  <div class="form-group col-sm-12 col-md-3 col-lg-6">
						...
						<input type="text" class="form-control" id="registerFullName" name="registerFullName">						<!-- <small id="emailHelp" class="form-text text-muted"></small> -->
					  </div>
                     ...
                     <div class="form-row">
					  ...
					  <button type="button" id="register" class="btn btn-success">Add User</button>
					  <button type="reset" class="btn">Clear</button>
					</form>
				  </div>
				</div>
